...
DROP FUNCTION IF EXISTS qgis_pkg.get_geometry_key_id(varchar, integer, integer, varchar);
...
WHERE fgm.cdb_schema = ',ql_cdb_schema,' 
	AND fgm.parent_objectclass_id = ',p_oc_id,' AND fgm.objectclass_id = ',oc_id,' AND fgm.geometry_name = ',ql_geom_name,';
');
...
END;
$$ LANGUAGE plpgsql;
COMMENT ON FUNCTION qgis_pkg.get_geometry_key_id(varchar, integer, integer, varchar) IS 'Lookup the primary key id of the given geometry name.';
REVOKE EXECUTE ON FUNCTION qgis_pkg.get_geometry_key_id(varchar, integer, integer, varchar) FROM public;
-- Example
...
-- Example
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 500, 11, 'lod', '1', 'Envelope', 'POLYGONZ', FALSE); --v
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 500, 11, 'lod', '1', 'Envelope', 'POLYGONZ', TRUE); --mv
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 502, 11, 'tin', '1', 'tin', 'MULTIPOLYGONZ', FALSE);
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 502, 11, 'tin', '1', 'tin', 'MULTIPOLYGONZ', TRUE);
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 901, 8, 'address', '0', 'MultiPoint', 'MULTIPOINTZ', FALSE);
...
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 901, 709, 11, 'lod2MultiSurface', '2', 'MultiSurface', 'MULTIPOLYGONZ', FALSE);
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 901, 11, 'lod1Solid', '1', 'Solid', 'POLYHEDRALSURFACEZ'); --v
-- SELECT * FROM qgis_pkg.create_geometry_view('qgis_bstsai','citydb', 0, 901, 11, 'lod1Solid', '1', 'Solid', 'POLYHEDRALSURFACEZ', TRUE); --mv
